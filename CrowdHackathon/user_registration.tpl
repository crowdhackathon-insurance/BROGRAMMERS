...
<div class="form-group">
 <form action="/user_registration.html" method="post">
   <div class="form-group">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="nama" name="nama" type="text" placeholder="Ονοματεπώνυμο" class="form-control input-md">
...
<ul class="row">
  <li class="col-md-3 col-md-offset-3">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        <input id="nama" name="nama" type="text" placeholder="Μάρκα Αυτοκινήτου" class="form-control input-md">
      </div>
    </div>
  </li>
  ...
  <li class="col-md-3">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        <input id="nama" name="nama" type="text" placeholder="Μοντέλο Αυτοκινήτου" class="form-control input-md">
      </div>
    </div>
  </li>
  ...
  <!-- Select Basic -->
    <div class="form-group">
      ...
      <div class="col-md-4">
        <input id="nama" name="nama" type="text" placeholder="Έτος Κυκλοφορίας" class="form-control input-md">
      </div>
    </div>
  </li>
</ul>
