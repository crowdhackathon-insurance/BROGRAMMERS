...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="nama" name="nama" type="text" placeholder="Αριθμός Κυκλοφορίας" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="nama" name="nama" type="text" placeholder="Ονοματεπώνυμο" value="<%=final[0]%>" class="form-control input-md">
...
<ul class="row">
  <li class="col-md-3 col-md-offset-3">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        <input id="nama" name="nama" type="text" placeholder="Μάρκα Αυτοκινήτου" value="<%=final[1]%>" class="form-control input-md">
      </div>
    </div>
  </li>
  ...
  <li class="col-md-3">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        <input id="nama" name="nama" type="text" placeholder="Μοντέλο Αυτοκινήτου" value="<%=final[2]%>" class="form-control input-md">
      </div>
    </div>
  </li>
  ...
  <!-- Select Basic -->
    <div class="form-group">
      ...
      <div class="col-md-4">
        <input id="nama" name="nama" type="text" placeholder="Έτος Κυκλοφορίας" value="<%=final[3]%>" class="form-control input-md">
      </div>
    </div>
  </li>
</ul>
